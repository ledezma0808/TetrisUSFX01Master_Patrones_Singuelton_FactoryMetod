...
ABlockPiedra::ABlockPiedra()
{
	...
	if (BlockMeshAsset.Succeeded())
	{
		...
		UMaterialInterface* materialEsfera = LoadObject<UMaterialInterface>(nullptr, TEXT("Material'/Game/StarterContent/Materials/M_CobbleStone_Rough.M_CobbleStone_Rough'"));
...
{
	UE_LOG(LogTemp, Warning, TEXT("Es un bloque: BlockPiedra"));
}
